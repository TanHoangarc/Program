...
import { LayoutDashboard, FileInput, Ship, Settings, Container, ArrowRightLeft, Building2, UserCircle, Briefcase } from 'lucide-react';

interface SidebarProps {
  currentPage: 'entry' | 'reports' | 'booking' | 'deposit-line' | 'deposit-customer' | 'lhk';
  onNavigate: (page: 'entry' | 'reports' | 'booking' | 'deposit-line' | 'deposit-customer' | 'lhk') => void;
}
    ...
    <div className="w-64 bg-slate-900 text-white h-screen fixed left-0 top-0 flex flex-col shadow-xl z-20">
      ...
      <nav className="flex-1 py-6 px-3 space-y-2">
        ...
        <div className="relative group">
          ...
          <div className="hidden group-hover:block absolute left-full top-0 ml-2 w-48 bg-slate-800 rounded-lg shadow-xl border border-slate-700 overflow-hidden z-50">
            <div 
