...
import { LayoutDashboard, FileInput, Ship, Container, ArrowRightLeft, Building2, UserCircle, Briefcase, FileUp, FileText, CreditCard, ShoppingCart, Database, RotateCcw, ChevronRight, WalletCards, Settings, Scale, BadgeDollarSign, LogOut, Send } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ currentPage, onNavigate, onResetData, currentUser, onLogout, onSendPending }) => {
  ...
  return (
    ...
    <div className="w-64 h-[96vh] fixed left-4 top-[2vh] flex flex-col z-50 rounded-3xl shadow-2xl border border-white/10 bg-slate-900">
      ...
      <nav className="relative z-10 flex-1 px-4 space-y-1 overflow-visible pt-4">
